        ...
        children: [
          Expanded(
            child: GestureDetector(
              ...
              child: Stack(
                children: [
                  Center(child: Image.asset('assets/images/snake.png',
                  fit: BoxFit.contain,),),
                  GridView.builder(
                    itemCount: noSquares,
              ...
              children: [
                ...
                Container(
                  ...
                  OutlinedButton(
                    ...
                    child: Row(
                      children: const[
                        Text('Start', style: TextStyle(color: Colors.yellow),),
                        SizedBox(
                          width: 5,
                        ),
            ...
            Container(
              height: 50, color: Colors.white12,
              child: Center(
                child: OutlinedButton(
                  ...
                  child: Text("Quit!", style: Theme.of(context).textTheme.subtitle2!.copyWith(color:Colors.white),)
                )
              )
            )
        ],
